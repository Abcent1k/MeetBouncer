...
(function (global, factory) {
  ...
  .rolldate-container .rolldate-dim-top {
      position: absolute;
      left: 0;
      top: 0;
      width: 100%;
      height: 68px;
      background: linear-gradient(0deg, rgba(22,31,41,0.3) 0%, rgba(30,42,55,1) 95%);
  ...
  .rolldate-container .rolldate-dim-bottom {
    position: absolute;
    left: 0;
    top: 0;
    width: 100%;
    height: 68px;
    background: linear-gradient(180deg, rgba(22,31,41,0.3) 0%, rgba(30,42,55,1) 95%);
    ...
    !(function (t, i) {
      ...
      function E(t, i, e, s, o, n, r) {
        var h = t - i,
          ...
          f = t + (a / l) * (h < 0 ? -1 : 1);
        return (
          u && c && (f = Math.round(f / c) * c), f < s ? ((f = n ? Math.max(s - n / 4, s - (n / d) * a) : s), (m = p)) : o < f && ((f = n ? Math.min(o + n / 4, o + (n / d) * a) : o), (m = p)), { destination: Math.round(f), duration: m }
        );
      }
      function D() { }
      var k,
      ...
      return (
        ...
        (k.prototype._handleDOMEvents = function (t) {
          ...
          t(window, "orientationchange", this),
            ...
            g && !this.options.disableTouch && (t(this.wrapper, "touchstart", this), t(i, "touchmove", this), t(i, "touchcancel", this), t(i, "touchend", this)),
        ...
        (k.prototype.refresh = function () {
          ...
          s
            ...
            : ((this.maxScrollX = this.wrapperWidth - this.scrollerWidth),
              ...
              this.maxScrollX < 0 ? ((this.maxScrollX -= this.relativeX), (this.minScrollX = -this.relativeX)) : 1 < this.scale && ((this.maxScrollX = this.maxScrollX / 2 - this.relativeX), (this.minScrollX = this.maxScrollX)),
              this.maxScrollY < 0 ? ((this.maxScrollY -= this.relativeY), (this.minScrollY = -this.relativeY)) : 1 < this.scale && ((this.maxScrollY = this.maxScrollY / 2 - this.relativeY), (this.minScrollY = this.maxScrollY))),
        ...
        ((P = A).prototype._start = function (t) {
          ...
          if ((1 === i || 0 === t.button) && !(!this.enabled || this.destroyed || (this.initiated && this.initiated !== i))) {
            (this.initiated = i),
              this.options.preventDefault && !X(t.target, this.options.preventDefaultException) && t.preventDefault(),
            ...
            if (!(r - this.endTime > this.options.momentumLimitTime && n < this.options.momentumLimitDistance && o < this.options.momentumLimitDistance)) {
              if (
                (this.directionLocked ||
                  ...
                  (o > n + this.options.directionLockThreshold ? (this.directionLocked = "h") : n >= o + this.options.directionLockThreshold ? (this.directionLocked = "v") : (this.directionLocked = "n")),
              ...
              !1 !== m && ((l = void 0 === m.top || m.top), (c = void 0 === m.bottom || m.bottom), (p = void 0 === m.left || m.left), (u = void 0 === m.right || m.right)),
                (h > this.minScrollX || h < this.maxScrollX) && (h = (h > this.minScrollX && p) || (h < this.maxScrollX && u) ? this.x + e / 3 : h > this.minScrollX ? this.minScrollX : this.maxScrollX),
                (a > this.minScrollY || a < this.maxScrollY) && (a = (a > this.minScrollY && l) || (a < this.maxScrollY && c) ? this.y + s / 3 : a > this.minScrollY ? this.minScrollY : this.maxScrollY),
                this.moved || ((this.moved = !0), this.trigger("scrollStart")),
                this._translate(h, a),
                r - this.startTime > this.options.momentumLimitTime && ((this.startTime = r), (this.startX = this.x), (this.startY = this.y), 1 === this.options.probeType && this.trigger("scroll", { x: this.x, y: this.y })),
              ...
              if (this._checkClick(t)) this.trigger("scrollCancel");
                ...
                if (this._events.flick && n < this.options.flickLimitTime && r < this.options.flickLimitDistance && h < this.options.flickLimitDistance) this.trigger("flick");
                  ...
                  if (this.options.snap) {
                    ...
                    (this.currentPage = w),
                      (a = this.options.snapSpeed || Math.max(Math.max(Math.min(Math.abs(i - w.x), 1e3), Math.min(Math.abs(e - w.y), 1e3)), 300)),
                      (i = w.x),
                      (e = w.y),
                      (this.directionX = 0),
                      (this.directionY = 0),
        ...
        (P.prototype._checkClick = function (t) {
          ...
          return (
            this.options.tap && ((i = t), (e = this.options.tap), (s = document.createEvent("Event")).initEvent(e, !0, !0), (s.pageX = i.pageX), (s.pageY = i.pageY), i.target.dispatchEvent(s)),
        ...
        (P.prototype._transitionEnd = function (t) {
          t.target === this.scroller &&
            this.isInTransition &&
            (this._transitionTime(),
              (!this.pulling || 1 === this.movingDirectionY) && !this.resetPosition(this.options.bounceTime, M.bounce) && ((this.isInTransition = !1), 3 !== this.options.probeType && this.trigger("scrollEnd", { x: this.x, y: this.y })));
        }),
          ...
          if (
            ((function (t, i) {
              ...
              this.options.useTransform
                ? (this.scrollerStyle[S.transform] = "translate(" + t + "px," + i + "px) scale(" + e + ")" + this.translateZ)
                : ((t = Math.round(t)), (i = Math.round(i)), (this.scrollerStyle.left = t + "px"), (this.scrollerStyle.top = i + "px")),
              this.options.wheel)
          )
            ...
            ((this.isInTransition = this.options.useTransition && 0 < e && (t !== this.x || i !== this.y)),
              !e || this.options.useTransition
                ? (this._transitionTimingFunction(s.style),
                  ...
                  e || (this.trigger("scroll", { x: t, y: i }), (this._reflow = document.body.offsetHeight), this.resetPosition(this.options.bounceTime, M.bounce) || this.trigger("scrollEnd", { x: t, y: i })),
                  this.options.wheel && (i > this.minScrollY ? (this.selectedIndex = 0) : i < this.maxScrollY ? (this.selectedIndex = this.items.length - 1) : (this.selectedIndex = Math.round(Math.abs(i / this.itemHeight)))))
  ...
  function Rolldate() {
    ...
    if (config.value) {
      ...
      var isTimeOnly = /^(\d{2}):(\d{2}):(\d{2})$/.test(str);
  ...
  Rolldate.prototype = {
    ...
    createUI: function createUI() {
      ...
      var $html = '<div class="rolldate-mask"></div>\n            <div class="rolldate-panel">\n                <section class="rolldate-content">\n                    <div class="rolldate-dim-top mask-top"></div>\n                    <div class="rolldate-dim-bottom mask-bottom"></div>\n                    <div class="rolldate-wrapper">\n                        ' + ul + '\n                    </div>\n                </section>\n            </div>',
